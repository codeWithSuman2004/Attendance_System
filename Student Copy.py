...
class Student:
    def __init__(self,root):
        ...
        bg_img=Label(self.root,bg="teal")
        ...
        #Home
        home=Button(bg_img,text="Home",command=self.backHome,width=17,font=("times new roman", 13, "bold"),bg="blue",fg="white")
        home.place(x=50,y=0,width=400,height=45)
